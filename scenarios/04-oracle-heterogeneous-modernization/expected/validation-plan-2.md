...
| Finance ledger: business validation of converted behaviour | Business users exercise the agreed scenarios and confirm the outcome | Explicit confirmation from the named business validators | Yes |
...
| Finance ledger: controls for SOX are in place and evidenced | Collect control evidence for each scope and review with the security owner | Every required control evidenced | Yes |
