...
| Convert schema and database code | build | database-owner | wave-2-business-critical-t-provision-nonprod | No | No |
| Remediate the application for the target | build | application-owner | wave-2-business-critical-t-provision-nonprod | No | No |
...
- Identifier: `wave-2-business-critical-t-convert-schema`
- Owner: database-owner
...
- Identifier: `wave-2-business-critical-t-application-remediation`
- Owner: application-owner
