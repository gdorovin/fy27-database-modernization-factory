...
| Target decisions | td-wl-billing-engine, td-wl-billing-history |
...
| --- | --- | --- | --- | --- |
| Billing engine | azure-sql-database | replatform | No | No |
| Billing history | azure-sql-database-hyperscale | replatform | No | No |
...
- Evidence: ev-csv-inventory-wl-billing-engine-inventor-77a09311, ev-csv-inventory-wl-billing-history-invento-28073f4b
- Risks: _none linked_
