...
| Target decisions | td-wl-case-management, td-wl-customer-master |
...
| --- | --- | --- | --- | --- |
| Case management | azure-sql-database | replatform | No | No |
| Customer master | azure-sql-database | replatform | No | No |
...
- Evidence: ev-csv-inventory-wl-case-management-invento-63b6a2aa, ev-csv-inventory-wl-customer-master-invento-9768c3a2
- Risks: _none linked_
