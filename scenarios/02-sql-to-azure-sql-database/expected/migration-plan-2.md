...
| Target decisions | td-wl-product-core, td-wl-product-events, td-wl-tenant-metadata |
...
| --- | --- | --- | --- | --- |
| Product core | azure-sql-database | replatform | No | No |
| Product events | azure-sql-database-hyperscale | replatform | No | No |
| Tenant metadata | azure-sql-database | replatform | No | No |
