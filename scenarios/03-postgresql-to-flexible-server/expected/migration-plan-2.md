...
| Target decisions | td-wl-routing-engine, td-wl-tracking-history |
...
| --- | --- | --- | --- | --- |
| Routing engine | azure-database-for-postgresql-flexible-server | replatform | No | No |
| Tracking history | azure-database-for-postgresql-flexible-server | replatform | No | No |
...
- Evidence: ev-csv-inventory-wl-routing-engine-inventor-2fe4c575, ev-csv-inventory-wl-tracking-history-invent-a97e4782
- Risks: _none linked_
