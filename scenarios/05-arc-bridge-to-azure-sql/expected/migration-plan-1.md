...
| Target decisions | td-wl-shared-services |
...
| --- | --- | --- | --- | --- |
| Shared services | azure-sql-database | replatform | No | No |
...
- Evidence: ev-arc-sql-wl-shared-services-arc-inventory-5e7d3c63, ev-csv-inventory-wl-shared-services-invento-92cb0bf9
- Risks: _none linked_
